...
async def get_construction_dashboard(payload: ConstructionDashboardRequest) -> Dict[str, Any]:
    try:
        ...
        return build_construction_dashboard(
            ...
            settlement_start_year=payload.settlement_start_year,
            settlement_start_month=payload.settlement_start_month,
            settlement_start_date=payload.settlement_start_date,
            settlement_end_year=payload.settlement_end_year,
            settlement_end_month=payload.settlement_end_month,
            settlement_end_date=payload.settlement_end_date,
